...
class ProductQuantization:
    ...
    def run_search(self, penetration_rate: float):
        ...
        PQ_code = pq_model.PQ_encode(gallery_embeddings, codebook)
        ...
        for probe_idx, probe_embedding in enumerate(tqdm(probe_embeddings)):
            ...
            distance_table, distances = pq_model.PQ_search(probe_embedding, codebook, PQ_code)
...
if __name__ == '__main__':
    ...
    hit_rates = []
    penetration_rates = []
    for penetration_rate in np.arange(0.01, 1.01, 0.25):  # step=0.01
